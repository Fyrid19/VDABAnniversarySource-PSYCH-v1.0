		...
		switch (FreeplaySelectState.freeplayCats[FreeplaySelectState.curCategory].toLowerCase())
			{
				...
				case 'dave':
					addWeek(['House', 'Insanity', 'Polygonized'], 1, 0xff00c3ff, ['dave', 'dave', 'dave-3d']);
					addWeek(['Bonus Song'], 1, 0xff00c3ff, ['dave']);
					addWeek(['Blocked','Corn Theft','Maze',], 2, 0xFF58cf08, ['bambi']);
					addWeek(['Splitathon'], 3, 0xFF27f5fb, ['the-duo']);
				case 'joke':
					addWeek(['Supernovae', 'Glitch', 'Vs Dave Thanksgiving'], 0, 0xFF58cf08, ['bambiJoke']);
					addWeek(['Rush E'], 4, 0xFF58cf08, ['bambi-3d-2']);
					if (FlxG.save.data.cheatingFound)
						addWeek(['Cheating'], 0, 0xff66ff00, ['bambi-3d']);
					if(FlxG.save.data.unfairnessFound)
						addWeek(['Unfairness'], 0, 0xFFf40000, ['expunged']);
				case 'extra':
					addWeek(['Mealie'], 0, 0xFF58cf08, ['bambi']);
					addWeek(['Furiosity'], 0, 0xff00c3ff, ['madman-dave']);
					addWeek(['Triple Trouble'], 4, 0xffb11c09, ['expunged']);
					addWeek(['Harmony'], 4, 0xff00c3ff, ['dave']);
					addWeek(["Rockin'"], 4, 0xFF58cf08, ['bambi']);
					addWeek(['Tales'], 4, 0xff00c3ff, ['dave']);
				case 'insanity':
					addWeek(['Reflective'], 4, 0xFF2767fb, ['barren']);
					addWeek(['Anillo'], 4, 0xFFeef029, ['lenzo']);
					addWeek(['Overdrive'], 4, 0xFFf40000, ['cbarren']);
			};
		...
		switch (FreeplaySelectState.freeplayCats[FreeplaySelectState.curCategory].toLowerCase())
			{
				...
				case 'dave':
					...
					addWeek(['Bonus-Song'], 2, 0xFF00dcff, ['dave']);
					addWeek(['Blocked','Corn-Theft','Maze',], 3, 0xFF58cf08, ['bambi']);
					addWeek(['Splitathon'], 4, 0xFF27f5fb, ['the-duo']);
				case 'joke':
					addWeek(['Supernovae', 'Glitch', 'Vs-Dave-Thanksgiving'], 1, 0xFF58cf08, ['bambiJoke']);
					if (FlxG.save.data.cheatingFound)
						addWeek(['Cheating'], 2, 0xFF58cf08, ['bambi-3d']);
					if(FlxG.save.data.unfairnessFound)
						addWeek(['Unfairness'], 3, 0xFFf40000, ['expunged']);
				case 'extra':
					addWeek(['Mealie'], 1, 0xFF58cf08, ['bambi']);
					addWeek(['Furiosity'], 2, 0xFF00dcff, ['madman-dave']);
			}
	}*/
