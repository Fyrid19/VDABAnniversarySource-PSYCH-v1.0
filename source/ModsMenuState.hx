...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		//noModsTxt = new FlxText(0, 0, FlxG.width, "NO MODS INSTALLED OR MOD ISN'T COMPATIBLE\nPRESS BACK TO EXIT AND INSTALL A MOD", 48);
		noModsTxt = new FlxText(0, 0, FlxG.width, "MODS MENU IS UNFINISHED\nDO NOT TRY TO LOAD MODS\nPRESS BACK TO EXIT", 48);
